...
- 🧭 **[Rutas guiadas por rol](rutas/README.md)** — recorridos ordenados para pentester, red team, SOC/blue, DFIR, **gestión de vulnerabilidades**, AppSec, cloud, GRC, **analista de ciberseguridad (institución regulada)**, **analista de seguridad ofensiva**, **security engineer / SecOps**, **jefe de seguridad / CISO** y **cooperación/alianzas técnicas**.
...
- **[Jefe de Seguridad de la Información / CISO](rutas/ciso-jefe-seguridad.md)** → Partes 0, 14, 17 (+ 8, 9 y base técnica) · el **techo de carrera** de las rutas defensivas y el primer rol con equipo a cargo: estrategia, riesgo, cumplimiento ISO 27001/NIST y reporte ejecutivo; alineado a **CISSP** (y CISM/ISO 27001 fuera del programa).

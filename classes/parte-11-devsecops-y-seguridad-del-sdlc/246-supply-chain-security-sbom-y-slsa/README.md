...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-246%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **11 — DevSecOps y seguridad del SDLC** · 📖 Fuente: SLSA Framework, NTIA "Minimum Elements for a SBOM" y NIST SP 800-218 (SSDF)
...
```mermaid
flowchart LR
    C["🔄 Clase 246<br/>Supply chain security"]
    C --> T1["1 · Ataques a la cadena de<br/>suministro"]
    C --> T2["2 · SBOM: qué es y para qué"]
    C --> T3["3 · CycloneDX vs SPDX"]
    C --> T4["4 · Generar y consumir SBOM"]
    C --> T5["5 · SLSA: niveles 1–4"]
    C --> T6["6 · Procedencia y atestaciones"]
    C --> T7["7 · Firma y verificación<br/>(cosign)"]

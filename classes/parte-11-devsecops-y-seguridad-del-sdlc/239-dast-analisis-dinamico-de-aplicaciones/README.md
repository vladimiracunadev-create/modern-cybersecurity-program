...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-239%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **11 — DevSecOps y seguridad del SDLC** · 📖 Fuente: *Securing DevOps* (Julien Vehent) y OWASP Web Security Testing Guide (WSTG)
...
flowchart LR
    C["🔄 Clase 239<br/>DAST"]
    C --> T1["1 · DAST vs SAST vs IAST"]
    C --> T2["2 · ZAP: proxy, spider, active<br/>scan"]
    C --> T3["3 · Passive vs active scanning"]
    C --> T4["4 · Autenticación en el<br/>escaneo"]
    C --> T5["5 · DAST en CI contra staging"]
    C --> T6["6 · Falsos positivos y tuning"]
    C --> T7["7 · Límites del DAST"]

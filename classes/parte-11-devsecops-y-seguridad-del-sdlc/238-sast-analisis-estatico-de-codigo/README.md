...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-238%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **11 — DevSecOps y seguridad del SDLC** · 📖 Fuente: *Securing DevOps* (Julien Vehent) y OWASP Source Code Analysis Tools
...
flowchart LR
    C["🔄 Clase 238<br/>SAST"]
    C --> T1["1 · Qué detecta y qué no el<br/>SAST"]
    C --> T2["2 · AST, data-flow y taint<br/>tracking"]
    C --> T3["3 · Semgrep: sintaxis de<br/>reglas"]
    C --> T4["4 · Rulesets y registry"]
    C --> T5["5 · Falsos positivos y falsos<br/>negativos"]
    C --> T6["6 · Integración en CI"]
    C --> T7["7 · Baseline y diff-aware<br/>scanning"]

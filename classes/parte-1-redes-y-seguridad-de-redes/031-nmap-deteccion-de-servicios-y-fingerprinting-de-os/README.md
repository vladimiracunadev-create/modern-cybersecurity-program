...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-031%20%2F%20340-6e7781?style=flat-square)](../../README.md)
...
flowchart LR
    C["🌐 Clase 031<br/>Nmap"]
    C --> T1["1 · Detección de versión (-sV)"]
    C --> T2["2 · Intensidad de sondeo<br/>(--version-intensity)"]
    C --> T3["3 · nmap-service-probes y CPE"]
    C --> T4["4 · OS fingerprinting (-O)"]
    C --> T5["5 · Fiabilidad y<br/>--osscan-guess"]
    C --> T6["6 · Escaneo agresivo (-A)"]
    C --> T7["7 · De versión a<br/>vulnerabilidad (CVE/CPE)"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-037%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **1 — Redes y seguridad de redes** · 📖 Fuente: *The Hacker Playbook; documentación de OpenSSH, proxychains, Chisel*
...
```mermaid
flowchart LR
    C["🌐 Clase 037<br/>Proxies, NAT y pivoting de<br/>red"]
    C --> T1["1 · NAT: SNAT, DNAT, PAT"]
    C --> T2["2 · Tipos de proxy"]
    C --> T3["3 · Port forwarding SSH<br/>local/remoto"]
    C --> T4["4 · SSH dynamic (SOCKS)"]
    C --> T5["5 · proxychains"]
    C --> T6["6 · Pivoting multi-salto"]
    C --> T7["7 · Detección defensiva del<br/>pivoting"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-055%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **2 — Criptografía aplicada** · 📖 Fuente: *Real-World Cryptography* (Wong) e IETF RFC 5280
...
```mermaid
flowchart LR
    C["🔐 Clase 055<br/>PKI, certificados X.509 y<br/>autoridades de…"]
    C --> T1["1 · Problema de confianza en<br/>claves"]
    C --> T2["2 · Certificado X.509"]
    C --> T3["3 · CA y cadena de confianza"]
    C --> T4["4 · CSR y emisión"]
    C --> T5["5 · Revocación (CRL/OCSP)"]
    C --> T6["6 · Certificate Transparency"]
    C --> T7["7 · Let's Encrypt / ACME"]

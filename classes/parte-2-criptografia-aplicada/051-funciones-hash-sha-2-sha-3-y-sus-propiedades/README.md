...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-051%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **2 — Criptografía aplicada** · 📖 Fuente: *Serious Cryptography* (Aumasson) y NIST FIPS 180-4 / FIPS 202
...
```mermaid
flowchart LR
    C["🔐 Clase 051<br/>Funciones hash"]
    C --> T1["1 · Qué es y qué no es un hash"]
    C --> T2["2 · Propiedades (preimagen,<br/>colisión)"]
    C --> T3["3 · Efecto avalancha"]
    C --> T4["4 · MD5 y SHA-1 rotos"]
    C --> T5["5 · SHA-2 y Merkle-Damgård"]
    C --> T6["6 · SHA-3 (esponja) y BLAKE"]
    C --> T7["7 · Extensión de longitud"]

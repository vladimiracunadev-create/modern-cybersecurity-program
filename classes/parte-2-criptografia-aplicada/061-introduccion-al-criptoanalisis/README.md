...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-061%20%2F%20340-6e7781?style=flat-square)](../../README.md)
...
```mermaid
flowchart LR
    C["🔐 Clase 061<br/>Introducción al<br/>criptoanálisis"]
    C --> T1["1 · Modelos de ataque<br/>(COA/KPA/CPA/CCA)"]
    C --> T2["2 · Análisis de frecuencias"]
    C --> T3["3 · Ataque de fuerza bruta y<br/>'bits de seguridad'"]
    C --> T4["4 · Paradoja del cumpleaños"]
    C --> T5["5 · Criptoanálisis diferencial"]
    C --> T6["6 · Criptoanálisis lineal"]
    C --> T7["7 · 'Roto' académico vs<br/>práctico"]

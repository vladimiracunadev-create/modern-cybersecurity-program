...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-047%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **2 — Criptografía aplicada** · 📖 Fuente: *Serious Cryptography* (Aumasson) y NIST FIPS 197 / SP 800-38A
...
```mermaid
flowchart LR
    C["🔐 Clase 047<br/>Cifrado simétrico"]
    C --> T1["1 · Cifrado por bloques vs de<br/>flujo"]
    C --> T2["2 · Interior de AES (rondas,<br/>S-box)"]
    C --> T3["3 · Modo ECB y su fallo"]
    C --> T4["4 · Modo CBC e IV"]
    C --> T5["5 · Modo CTR"]
    C --> T6["6 · Padding (PKCS#7)"]
    C --> T7["7 · GCM / AEAD (adelanto)"]

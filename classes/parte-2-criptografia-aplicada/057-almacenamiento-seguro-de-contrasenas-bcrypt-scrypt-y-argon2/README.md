...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-057%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **2 — Criptografía aplicada** · 📖 Fuente: *Real-World Cryptography* (Wong) y OWASP Password Storage Cheat Sheet
...
```mermaid
flowchart LR
    C["🔐 Clase 057<br/>Almacenamiento seguro de<br/>contraseñas"]
    C --> T1["1 · Por qué no SHA-256 para<br/>contraseñas"]
    C --> T2["2 · Salt (por usuario)"]
    C --> T3["3 · Pepper (secreto global)"]
    C --> T4["4 · bcrypt y factor de coste"]
    C --> T5["5 · scrypt y Argon2<br/>(memory-hard)"]
    C --> T6["6 · Verificación en tiempo<br/>constante"]
    C --> T7["7 · Ataques con hashcat (lab)"]

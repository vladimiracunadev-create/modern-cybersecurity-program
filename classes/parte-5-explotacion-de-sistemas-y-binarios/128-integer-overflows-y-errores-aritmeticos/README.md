...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-128%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **5 — Explotación de sistemas y binarios** · 📖 Fuente: *The Shellcoder's Handbook* · CWE-190/191
...
```mermaid
flowchart LR
    C["💥 Clase 128<br/>Integer overflows y errores<br/>aritméticos"]
    C --> T1["1 · Representación de enteros<br/>y wrap-around"]
    C --> T2["2 · Signed vs unsigned"]
    C --> T3["3 · Truncamiento (int→short)"]
    C --> T4["4 · Overflow en cálculo de<br/>tamaño"]
    C --> T5["5 · De integer bug a heap<br/>overflow"]
    C --> T6["6 · Off-by-one"]
    C --> T7["7 · UBSan"]
    C --> T8["8 · Aritmética segura"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-122%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **5 — Explotación de sistemas y binarios** · 📖 Fuente: *Andriesse, Practical Binary Analysis* · docs GCC/Linux
...
```mermaid
flowchart LR
    C["💥 Clase 122<br/>Protecciones modernas"]
    C --> T1["1 · ASLR"]
    C --> T2["2 · DEP/NX"]
    C --> T3["3 · Stack canary"]
    C --> T4["4 · PIE"]

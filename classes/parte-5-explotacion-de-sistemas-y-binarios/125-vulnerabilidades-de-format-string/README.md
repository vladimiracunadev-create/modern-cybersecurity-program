...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-125%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **5 — Explotación de sistemas y binarios** · 📖 Fuente: *Erickson, Hacking 2e* · CWE-134
...
```mermaid
flowchart LR
    C["💥 Clase 125<br/>Vulnerabilidades de format<br/>string"]
    C --> T1["1 · Cómo funciona printf y sus<br/>especificadores"]
    C --> T2["2 · %p/%x para leer la pila"]
    C --> T3["3 · Offset de argumento"]
    C --> T4["4 · %n para escribir"]
    C --> T5["5 · Escritura con %hn/%hhn"]
    C --> T6["6 · Sobrescritura de la GOT"]
    C --> T7["7 · fmtstrpayload"]
    C --> T8["8 · Mitigaciones (FORTIFY,<br/>-Wformat)"]

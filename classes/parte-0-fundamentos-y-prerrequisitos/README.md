...
Tres clases sin teclado, y son las que más te ahorrarán después. Aquí se fija el **vocabulario** con el que vas a razonar durante las 360 clases del programa: qué se protege exactamente, quién ataca y con qué lógica, y qué marcos usa la industria para hablar de todo ello sin reinventar los términos cada vez.

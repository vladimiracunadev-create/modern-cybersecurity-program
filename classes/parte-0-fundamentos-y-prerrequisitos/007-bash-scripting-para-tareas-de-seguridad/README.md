...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-007%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **0 — Fundamentos y prerrequisitos** · 📖 Fuente: *GNU Bash Reference Manual*
...
```mermaid
flowchart LR
    C["🧱 Clase 007<br/>Bash scripting para tareas<br/>de seguridad"]
    C --> T1["1 · Shebang y ejecución"]
    C --> T2["2 · Variables y expansión"]
    C --> T3["3 · Condicionales [[ ]]"]
    C --> T4["4 · Bucles for/while"]
    C --> T5["5 · Funciones"]
    C --> T6["6 · Argumentos y getopts"]
    C --> T7["7 · Robustez"]
    C --> T8["8 · Códigos de salida"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-001%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **0 — Fundamentos y prerrequisitos** · 📖 Fuente: *NIST SP 800-12 Rev. 1 / CSF 2.0*
...
```mermaid
flowchart LR
    C["🧱 Clase 001<br/>Qué es la ciberseguridad"]
    C --> T1["1 · Tríada CIA"]
    C --> T2["2 · Propiedades extendidas"]
    C --> T3["3 · Modelo AAA"]
    C --> T4["4 · Superficie de ataque"]
    C --> T5["5 · Vectores y amenazas"]
    C --> T6["6 · Defensa en profundidad"]
    C --> T7["7 · Principio de mínimo<br/>privilegio"]
    C --> T8["8 · Modelos zero trust"]

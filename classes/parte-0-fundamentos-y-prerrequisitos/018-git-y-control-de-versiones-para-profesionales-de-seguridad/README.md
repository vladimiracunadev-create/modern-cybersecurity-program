...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-018%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **0 — Fundamentos y prerrequisitos** · 📖 Fuente: *Chacon & Straub, Pro Git*
...
```mermaid
flowchart LR
    C["🧱 Clase 018<br/>Git y control de versiones<br/>para profesionales…"]
    C --> T1["1 · Modelo de Git"]
    C --> T2["2 · Flujo básico"]
    C --> T3["3 · Ramas y merge"]
    C --> T4["4 · Conflictos"]
    C --> T5["5 · Remotos"]
    C --> T6["6 · .gitignore"]
    C --> T7["7 · Secretos en el historial"]
    C --> T8["8 · Escaneo de secretos"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-015%20%2F%20340-6e7781?style=flat-square)](../../README.md)
...
```mermaid
flowchart LR
    C["🧱 Clase 015<br/>Python para seguridad"]
    C --> T1["1 · Tipos y variables"]
    C --> T2["2 · Estructuras de datos"]
    C --> T3["3 · Control de flujo"]
    C --> T4["4 · Funciones y módulos"]
    C --> T5["5 · Archivos"]
    C --> T6["6 · Excepciones"]
    C --> T7["7 · Librería estándar"]
    C --> T8["8 · Entornos virtuales"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-019%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **0 — Fundamentos y prerrequisitos** · 📖 Fuente: *Friedl, Mastering Regular Expressions (O'Reilly)*
...
```mermaid
flowchart LR
    C["🧱 Clase 019<br/>Expresiones regulares para<br/>análisis de logs y…"]
    C --> T1["1 · Literales y metacaracteres"]
    C --> T2["2 · Clases de caracteres"]
    C --> T3["3 · Cuantificadores"]
    C --> T4["4 · Anclas y límites"]
    C --> T5["5 · Grupos y captura"]
    C --> T6["6 · Codicia y pereza"]
    C --> T7["7 · Extracción de IOCs"]
    C --> T8["8 · ReDoS"]

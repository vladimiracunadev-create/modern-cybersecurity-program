...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-025%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **0 — Fundamentos y prerrequisitos** · 📖 Fuente: *EC-Council Code of Ethics / ISO/IEC 29147 y 30111*
...
```mermaid
flowchart LR
    C["🧱 Clase 025<br/>Ética, legalidad, alcance y<br/>divulgación…"]
    C --> T1["1 · Autorización"]
    C --> T2["2 · Alcance (scope)"]
    C --> T3["3 · Reglas de compromiso (RoE)"]
    C --> T4["4 · Marco legal"]
    C --> T5["5 · Tipos de hacker"]
    C --> T6["6 · Divulgación responsable"]
    C --> T7["7 · Manejo de datos"]
    C --> T8["8 · Ética profesional"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-012%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **0 — Fundamentos y prerrequisitos** · 📖 Fuente: *RFC 1035 (DNS), RFC 2131 (DHCP), RFC 826 (ARP)*
...
```mermaid
flowchart LR
    C["🧱 Clase 012<br/>DNS, DHCP y ARP"]
    C --> T1["1 · Resolución DNS"]
    C --> T2["2 · Tipos de registro"]
    C --> T3["3 · Caché y recursión"]
    C --> T4["4 · DHCP DORA"]
    C --> T5["5 · ARP"]
    C --> T6["6 · ARP spoofing"]
    C --> T7["7 · DNS/DHCP rogue"]
    C --> T8["8 · Defensas"]

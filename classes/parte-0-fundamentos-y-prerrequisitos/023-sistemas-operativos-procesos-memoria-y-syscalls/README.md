...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-023%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **0 — Fundamentos y prerrequisitos** · 📖 Fuente: *Tanenbaum & Bos, Modern Operating Systems*
...
```mermaid
flowchart LR
    C["🧱 Clase 023<br/>Sistemas operativos"]
    C --> T1["1 · Procesos e hilos"]
    C --> T2["2 · Estados y planificación"]
    C --> T3["3 · Layout de memoria"]
    C --> T4["4 · Memoria virtual"]
    C --> T5["5 · Modo usuario/kernel"]
    C --> T6["6 · Syscalls"]
    C --> T7["7 · Herramientas de traza"]
    C --> T8["8 · Relevancia ofensiva"]

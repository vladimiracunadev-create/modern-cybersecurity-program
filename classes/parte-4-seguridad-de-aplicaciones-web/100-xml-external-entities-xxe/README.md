...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-100%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **4 — Seguridad de aplicaciones web** · 📖 Fuente: *The Web Application Hacker's Handbook* / *OWASP*
...
```mermaid
flowchart LR
    C["🕸️ Clase 100<br/>XML External Entities (XXE)"]
    C --> T1["1 · XML, DTD y entidades"]
    C --> T2["2 · Entidades externas"]
    C --> T3["3 · Lectura de archivos<br/>locales"]
    C --> T4["4 · XXE → SSRF"]
    C --> T5["5 · XXE ciega y OOB con DTD<br/>externo"]
    C --> T6["6 · XXE en SAML, DOCX, SVG"]
    C --> T7["7 · Defensa: deshabilitar<br/>DTD/entidades"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-110%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **4 — Seguridad de aplicaciones web** · 📖 Fuente: *OWASP API Security Top 10* / *Bug Bounty Bootcamp (Vickie Li)*
...
```mermaid
flowchart LR
    C["🕸️ Clase 110<br/>Seguridad de APIs REST"]
    C --> T1["1 · OWASP API Security Top 10"]
    C --> T2["2 · Enumeración de endpoints"]
    C --> T3["3 · BOLA (API1)"]
    C --> T4["4 · Broken Function Level Auth<br/>(API5)"]
    C --> T5["5 · Excessive Data Exposure y<br/>mass assignment"]
    C --> T6["6 · Rate limiting y abuso"]
    C --> T7["7 · Defensa: authz granular"]

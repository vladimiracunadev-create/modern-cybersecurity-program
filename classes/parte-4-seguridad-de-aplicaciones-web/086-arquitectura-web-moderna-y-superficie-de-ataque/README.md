...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-086%20%2F%20340-6e7781?style=flat-square)](../../README.md)
...
```mermaid
flowchart LR
    C["🕸️ Clase 086<br/>Arquitectura web moderna y<br/>superficie de ataque"]
    C --> T1["1 · Modelo cliente-servidor y<br/>HTTP/HTTPS"]
    C --> T2["2 · SPA vs. render en servidor<br/>(SSR)"]
    C --> T3["3 · APIs REST/GraphQL como<br/>backend"]
    C --> T4["4 · Autenticación, sesiones y<br/>tokens"]
    C --> T5["5 · Proxies, CDN, WAF y<br/>balanceadores"]
    C --> T6["6 · Servicios cloud y metadata"]
    C --> T7["7 · Puntos de entrada de datos"]

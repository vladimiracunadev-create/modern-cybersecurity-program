...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-106%20%2F%20340-6e7781?style=flat-square)](../../README.md)
...
```mermaid
flowchart LR
    C["🕸️ Clase 106<br/>Deserialización insegura"]
    C --> T1["1 · Serialización: concepto"]
    C --> T2["2 · Formatos por lenguaje"]
    C --> T3["3 · Manipulación de estado"]
    C --> T4["4 · Gadget chains"]
    C --> T5["5 · ysoserial y herramientas"]
    C --> T6["6 · Pickle en Python"]
    C --> T7["7 · Defensa: no deserializar<br/>input"]

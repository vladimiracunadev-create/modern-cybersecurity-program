...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-101%20%2F%20340-6e7781?style=flat-square)](../../README.md)
...
```mermaid
flowchart LR
    C["🕸️ Clase 101<br/>Fallos de autenticación y<br/>bypass"]
    C --> T1["1 · Enumeración de usuarios"]
    C --> T2["2 · Fuerza bruta y stuffing"]
    C --> T3["3 · Rate limiting y su evasión"]
    C --> T4["4 · Recuperación de contraseña"]
    C --> T5["5 · MFA: tipos y bypass"]
    C --> T6["6 · Lógica de login rota"]
    C --> T7["7 · Defensa en profundidad"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-109%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **4 — Seguridad de aplicaciones web** · 📖 Fuente: *Real-World Bug Hunting (Yaworski)* / *PortSwigger*
...
```mermaid
flowchart LR
    C["🕸️ Clase 109<br/>Vulnerabilidades de lógica<br/>de negocio"]
    C --> T1["1 · Qué es una falla de lógica"]
    C --> T2["2 · Suposiciones del<br/>desarrollador"]
    C --> T3["3 · Manipulación de<br/>precios/cantidades"]
    C --> T4["4 · Flow bypass"]
    C --> T5["5 · Race conditions"]
    C --> T6["6 · Abuso de<br/>descuentos/cupones"]
    C --> T7["7 · Defensa: validar reglas en<br/>servidor"]

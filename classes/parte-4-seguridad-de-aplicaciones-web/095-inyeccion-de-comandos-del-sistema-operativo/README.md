...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-095%20%2F%20340-6e7781?style=flat-square)](../../README.md)
...
```mermaid
flowchart LR
    C["🕸️ Clase 095<br/>Inyección de comandos del<br/>sistema operativo"]
    C --> T1["1 · Cómo el input llega al<br/>shell"]
    C --> T2["2 · Metacaracteres de<br/>encadenado"]
    C --> T3["3 · Command injection ciega"]
    C --> T4["4 · Detección temporal y OOB"]
    C --> T5["5 · Reverse shell en lab"]
    C --> T6["6 · Diferencias Linux/Windows"]
    C --> T7["7 · Defensa: evitar system(),<br/>allowlists"]

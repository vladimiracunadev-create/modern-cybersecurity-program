...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-328%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **17 — Profundización para certificaciones** · 📖 Fuente: *(ISC)² CISSP OSG — Security and Risk Management* · *The Open Group — Open FAIR (O-RT, O-RA)* · *NIST SP 800-34 (Contingency Planning)*
...
```mermaid
flowchart LR
    C["📈 Clase 328<br/>Gestión de riesgos<br/>cuantitativa y continuidad…"]
    C --> T1["1 · Riesgo cualitativo vs<br/>cuantitativo"]
    C --> T2["2 · SLE, ARO, ALE"]
    C --> T3["3 · Taxonomía FAIR"]
    C --> T4["4 · Distribuciones e<br/>incertidumbre<br/>(PERT/lognormal)"]
    C --> T5["5 · Simulación de Monte Carlo"]
    C --> T6["6 · ROSI y decisión de control"]
    C --> T7["7 · BIA: procesos críticos,<br/>MTD, RTO, RPO"]
    C --> T8["8 · Estrategias de continuidad<br/>y DR"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-318%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **17 — Profundización para certificaciones** · 📖 Fuente: *CompTIA CySA+ (CS0-003) Study Guide — Chapple & Seidl* · *NIST SP 800-40 Rev.4*
...
```mermaid
flowchart LR
    C["📈 Clase 318<br/>Gestión del programa de<br/>vulnerabilidades"]
    C --> T1["1 · Ciclo de vida de VM"]
    C --> T2["2 · Inventario y cobertura de<br/>activos"]
    C --> T3["3 · Descubrimiento: escaneo<br/>autenticado vs no<br/>autenticado"]
    C --> T4["4 · CVSS<br/>(Base/Temporal/Environmental)"]
    C --> T5["5 · EPSS"]
    C --> T6["6 · CISA KEV"]
    C --> T7["7 · SLAs de remediación y<br/>excepciones"]
    C --> T8["8 · Métricas y madurez del<br/>programa"]

...
```mermaid
flowchart LR
  A[Supuesto de centro-dispersi-n-y-percentiles] --> B[Abuso controlado]
...
- Epic Games, *Networking Overview* — autoridad y replicación aplicadas a Z-score, IQR y ventanas. <https://dev.epicgames.com/documentation/unreal-engine/networking-overview-for-unreal-engine>
- Valve, *Latency Compensating Methods* — predicción, interpolación y límites usados para Precision, recall y errores. <https://developer.valvesoftware.com/wiki/Latency_Compensating_Methods_in_Client/Server_In-game_Protocol_Design_and_Optimization>
- scikit-learn, *Outlier detection* — límites de detección de anomalías y evaluación en la clase 357. <https://scikit-learn.org/stable/modules/outlier_detection.html>

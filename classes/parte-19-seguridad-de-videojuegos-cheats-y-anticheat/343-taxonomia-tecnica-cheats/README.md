...
```mermaid
flowchart LR
  A[Supuesto de estado-recursos-y-movimiento] --> B[Abuso controlado]
...
- Epic Games, *Networking Overview* — autoridad y replicación aplicadas a Internal, external e input-based. <https://dev.epicgames.com/documentation/unreal-engine/networking-overview-for-unreal-engine>
- Valve, *Latency Compensating Methods* — predicción, interpolación y límites usados para Automatización conductual y señales. <https://developer.valvesoftware.com/wiki/Latency_Compensating_Methods_in_Client/Server_In-game_Protocol_Design_and_Optimization>
- Montero et al., *Anticheat System Based on Reinforcement Learning Agents in Unity* — ejemplo académico para contrastar prevención y detección en la clase 343. <https://doi.org/10.3390/info13040173>

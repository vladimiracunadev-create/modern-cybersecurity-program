...
```mermaid
flowchart LR
  A[Supuesto de invariants-y-sanity-checks] --> B[Abuso controlado]
...
- Epic Games, *Networking Overview* — autoridad y replicación aplicadas a Rate limits y state machines. <https://dev.epicgames.com/documentation/unreal-engine/networking-overview-for-unreal-engine>
- Valve, *Latency Compensating Methods* — predicción, interpolación y límites usados para Reconciliación y regression tests. <https://developer.valvesoftware.com/wiki/Latency_Compensating_Methods_in_Client/Server_In-game_Protocol_Design_and_Optimization>
- Montero et al., *Anticheat System Based on Reinforcement Learning Agents in Unity* — ejemplo académico para contrastar prevención y detección en la clase 354. <https://doi.org/10.3390/info13040173>

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-309%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **16 — Capstones y preparación de certificaciones** · 📖 Fuente: *The Cyber Plumber's Handbook · DetectionLab · buenas prácticas de la comunidad*
...
```mermaid
flowchart LR
    C["🏁 Clase 309<br/>Construcción de portafolio y<br/>home lab permanente"]
    C --> T1["1 · Qué incluir en el<br/>portafolio"]
    C --> T2["2 · Writeups y CTFs"]
    C --> T3["3 · Informes anonimizados"]
    C --> T4["4 · Home lab con IaC"]
    C --> T5["5 · Blog técnico y GitHub"]
    C --> T6["6 · Anonimización y ética"]
    C --> T7["7 · Marca profesional"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-301%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **16 — Capstones y preparación de certificaciones** · 📖 Fuente: *CompTIA Certification Roadmap · (ISC)² CISSP Official Study Guide · Offensive Security PEN-200*
...
```mermaid
flowchart LR
    C["🏁 Clase 301<br/>Roadmap de certificaciones"]
    C --> T1["1 · Base: Security+, Network+"]
    C --> T2["2 · Ofensivo: PenTest+, eJPT,<br/>OSCP, OSEP"]
    C --> T3["3 · Defensivo: CySA+, GCIH,<br/>GCFA, BTL"]
    C --> T4["4 · Gestión/GRC: CISSP, CISM,<br/>CISA"]
    C --> T5["5 · Cloud: AWS Security,<br/>AZ-500, CCSP"]
    C --> T6["6 · Coste real y vigencia"]
    C --> T7["7 · Orden por perfil"]
...
| "El CISSP me rechazó el endorsement" | No cumples 5 años de experiencia; quedas como *Associate* hasta acumularla. |

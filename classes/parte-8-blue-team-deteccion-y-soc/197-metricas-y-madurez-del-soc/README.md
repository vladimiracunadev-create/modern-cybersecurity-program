...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-197%20%2F%20340-6e7781?style=flat-square)](../../README.md)
...
```mermaid
flowchart LR
    C["🔵 Clase 197<br/>Métricas y madurez del SOC"]
    C --> T1["1 · Para qué medir"]
    C --> T2["2 · MTTD, MTTR, dwell time"]
    C --> T3["3 · Métricas de calidad de<br/>detección"]
    C --> T4["4 · Métricas vanidosas y<br/>gaming"]
    C --> T5["5 · Cobertura ATT&CK como<br/>métrica"]
    C --> T6["6 · SOC-CMM y madurez"]
    C --> T7["7 · Cuadro de mando por<br/>audiencia"]
    C --> T8["8 · De la métrica a la acción"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-193%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **8 — Blue Team, detección y SOC** · 📖 Fuente: *Applied Network Security Monitoring* — Sanders y Smith · *MITRE ATT&CK* (Command and Control)
...
```mermaid
flowchart LR
    C["🔵 Clase 193<br/>Detección de C2 y beaconing"]
    C --> T1["1 · Anatomía de un canal C2"]
    C --> T2["2 · Beaconing: intervalo y<br/>jitter"]
    C --> T3["3 · C2 sobre HTTP/S"]
    C --> T4["4 · C2 sobre DNS"]
    C --> T5["5 · Malleable C2 y evasión"]
    C --> T6["6 · JA3/JA3S y fingerprints"]
    C --> T7["7 · Análisis estadístico<br/>(RITA)"]
    C --> T8["8 · Correlación con endpoint"]

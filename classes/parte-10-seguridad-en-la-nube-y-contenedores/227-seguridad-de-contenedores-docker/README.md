...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-227%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **10 — Seguridad en la nube y contenedores** · 📖 Fuente: *Liz Rice, "Container Security" (O'Reilly) y CIS Docker Benchmark*
...
```mermaid
flowchart LR
    C["☁️ Clase 227<br/>Seguridad de contenedores"]
    C --> T1["1 · Namespaces y cgroups"]
    C --> T2["2 · Capabilities y user<br/>namespaces"]
    C --> T3["3 · Imágenes y capas"]
    C --> T4["4 · Dockerfile seguro y<br/>multi-stage"]
    C --> T5["5 · Escaneo de imágenes<br/>(Trivy)"]
    C --> T6["6 · Runtime seguro (seccomp,<br/>AppArmor)"]
    C --> T7["7 · Registro y firma de<br/>imágenes"]

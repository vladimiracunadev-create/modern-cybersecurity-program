...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-231%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **10 — Seguridad en la nube y contenedores** · 📖 Fuente: *Documentación de Prowler y ScoutSuite, y CIS Benchmarks multi-cloud*
...
```mermaid
flowchart LR
    C["☁️ Clase 231<br/>Cloud Security Posture<br/>Management (CSPM)"]
    C --> T1["1 · Qué es CSPM"]
    C --> T2["2 · CSPM vs escaneo IaC"]
    C --> T3["3 · Prowler"]
    C --> T4["4 · ScoutSuite"]
    C --> T5["5 · Marcos de cumplimiento"]
    C --> T6["6 · Priorización de hallazgos"]
    C --> T7["7 · Ciclo de remediación y<br/>métricas"]

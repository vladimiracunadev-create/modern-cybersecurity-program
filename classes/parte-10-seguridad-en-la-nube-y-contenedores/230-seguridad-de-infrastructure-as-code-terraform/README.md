...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-230%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **10 — Seguridad en la nube y contenedores** · 📖 Fuente: *HashiCorp Terraform docs y OWASP Infrastructure as Code Security*
...
```mermaid
flowchart LR
    C["☁️ Clase 230<br/>Seguridad de Infrastructure<br/>as Code (Terraform)"]
    C --> T1["1 · IaC y drift"]
    C --> T2["2 · Escaneo estático<br/>(tfsec/Checkov)"]
    C --> T3["3 · Gestión del state"]
    C --> T4["4 · Secretos en Terraform"]
    C --> T5["5 · Módulos y proveedores<br/>confiables"]
    C --> T6["6 · Policy-as-code<br/>(OPA/Sentinel)"]
    C --> T7["7 · IaC en el pipeline CI/CD"]

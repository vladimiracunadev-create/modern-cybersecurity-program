...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-259%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **12 — OSINT e ingeniería social** · 📖 Fuente: NIST SP 800-50 · *Social Engineering* (C. Hadnagy) · ENISA
...
```mermaid
flowchart LR
    C["🕵️ Clase 259<br/>Defensa contra la ingeniería<br/>social"]
    C --> T1["1 · Autenticación de correo"]
    C --> T2["2 · MFA resistente a phishing"]
    C --> T3["3 · Filtros y sandboxing"]
    C --> T4["4 · Verificación de identidad"]
    C --> T5["5 · Concienciación medible"]
    C --> T6["6 · Botón de reporte"]
    C --> T7["7 · Respuesta a incidentes SE"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-254%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **12 — OSINT e ingeniería social** · 📖 Fuente: Documentación de Shodan y Censys · *Open Source Intelligence Techniques* (M. Bazzell)
...
```mermaid
flowchart LR
    C["🕵️ Clase 254<br/>OSINT técnico"]
    C --> T1["1 · Qué indexan Shodan/Censys"]
    C --> T2["2 · Filtros y dorks de Shodan"]
    C --> T3["3 · Censys y búsqueda por<br/>certificados"]
    C --> T4["4 · Servicios de alto riesgo"]
    C --> T5["5 · CLI y API"]
    C --> T6["6 · Atribución de activos"]
    C --> T7["7 · Priorización y reporte"]

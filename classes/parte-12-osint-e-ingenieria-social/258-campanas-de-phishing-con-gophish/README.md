...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-258%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **12 — OSINT e ingeniería social** · 📖 Fuente: Documentación de GoPhish · *Social Engineering* (C. Hadnagy)
...
```mermaid
flowchart LR
    C["🕵️ Clase 258<br/>Campañas de phishing con<br/>GoPhish"]
    C --> T1["1 · Arquitectura de GoPhish"]
    C --> T2["2 · Sending profile (SMTP)"]
    C --> T3["3 · Plantillas de correo"]
    C --> T4["4 · Landing pages"]
    C --> T5["5 · Grupos y segmentación"]
    C --> T6["6 · Métricas y tracking"]
    C --> T7["7 · Informe y formación"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-274%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **13 — Seguridad móvil, IoT e inalámbrica** · 📖 Fuente: *The Car Hacker's Handbook* (Craig Smith) y documentación de can-utils
...
```mermaid
flowchart LR
    C["📡 Clase 274<br/>Seguridad automotriz y bus<br/>CAN"]
    C --> T1["1 · Arquitectura del vehículo"]
    C --> T2["2 · Bus CAN y trama"]
    C --> T3["3 · OBD-II y acceso físico"]
    C --> T4["4 · SocketCAN y can-utils"]
    C --> T5["5 · Ingeniería inversa de<br/>tramas"]
    C --> T6["6 · UDS y diagnóstico"]
    C --> T7["7 · Superficies remotas y<br/>defensa"]

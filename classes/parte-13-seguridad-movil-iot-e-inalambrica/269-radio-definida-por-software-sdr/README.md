...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-269%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **13 — Seguridad móvil, IoT e inalámbrica** · 📖 Fuente: *Practical IoT Hacking* (Chantzis et al.) y documentación de GNU Radio
...
```mermaid
flowchart LR
    C["📡 Clase 269<br/>Radio definida por software<br/>(SDR)"]
    C --> T1["1 · Fundamentos de RF e IQ"]
    C --> T2["2 · Hardware SDR<br/>(RTL-SDR/HackRF)"]
    C --> T3["3 · Waterfall y descubrimiento"]
    C --> T4["4 · Modulaciones (OOK/ASK,<br/>FSK)"]
    C --> T5["5 · Captura IQ"]
    C --> T6["6 · GNU Radio y URH"]
    C --> T7["7 · Legalidad del espectro"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-268%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **13 — Seguridad móvil, IoT e inalámbrica** · 📖 Fuente: *Practical IoT Hacking* (Chantzis et al.) y *The Hardware Hacking Handbook* (Woudenberg, O'Flynn)
...
```mermaid
flowchart LR
    C["📡 Clase 268<br/>Análisis de hardware"]
    C --> T1["1 · Seguridad eléctrica y<br/>voltajes"]
    C --> T2["2 · Identificación de puertos<br/>en PCB"]
    C --> T3["3 · UART: consola serie"]
    C --> T4["4 · Analizador lógico"]
    C --> T5["5 · JTAG/SWD con OpenOCD"]
    C --> T6["6 · SPI y volcado de flash"]
    C --> T7["7 · Contramedidas del<br/>fabricante"]

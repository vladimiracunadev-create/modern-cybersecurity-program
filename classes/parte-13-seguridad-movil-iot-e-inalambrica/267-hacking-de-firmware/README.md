...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-267%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **13 — Seguridad móvil, IoT e inalámbrica** · 📖 Fuente: *Practical IoT Hacking* (Chantzis et al.) y OWASP FSTM
...
```mermaid
flowchart LR
    C["📡 Clase 267<br/>Hacking de firmware"]
    C --> T1["1 · Obtención del firmware"]
    C --> T2["2 · Formatos y binwalk"]
    C --> T3["3 · Sistemas de ficheros<br/>(SquashFS, JFFS2)"]
    C --> T4["4 · Búsqueda de secretos"]
    C --> T5["5 · Análisis de binarios"]
    C --> T6["6 · Emulación con QEMU"]
    C --> T7["7 · Seguridad de la<br/>actualización"]

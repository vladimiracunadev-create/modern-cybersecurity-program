...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-208%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **9 — Forense digital y respuesta a incidentes** · 📖 Fuente: *NIST SP 800-86* y documentación de Wireshark/Zeek
...
```mermaid
flowchart LR
    C["🔬 Clase 208<br/>Forense de red"]
    C --> T1["1 · Fuentes: PCAP vs. flujo<br/>(NetFlow)"]
    C --> T2["2 · Filtros de captura y<br/>display"]
    C --> T3["3 · Reensamblado de sesiones<br/>TCP"]
    C --> T4["4 · Extracción de archivos"]
    C --> T5["5 · Detección de C2 y<br/>beaconing"]
    C --> T6["6 · Exfiltración por DNS/HTTP"]
    C --> T7["7 · Zeek (logs de red)"]
    C --> T8["8 · TLS y tráfico cifrado"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-203%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **9 — Forense digital y respuesta a incidentes** · 📖 Fuente: *Brian Carrier — File System Forensic Analysis* y *NIST SP 800-86*
...
```mermaid
flowchart LR
    C["🔬 Clase 203<br/>Adquisición forense"]
    C --> T1["1 · Física vs. lógica vs.<br/>volumen"]
    C --> T2["2 · Formatos RAW y E01/EWF"]
    C --> T3["3 · Bloqueo de escritura"]
    C --> T4["4 · dd y dcfldd"]
    C --> T5["5 · ewfacquire y FTK Imager"]
    C --> T6["6 · Hashing durante<br/>adquisición"]
    C --> T7["7 · Adquisición en vivo vs.<br/>apagado"]
    C --> T8["8 · Discos cifrados y SSD/TRIM"]

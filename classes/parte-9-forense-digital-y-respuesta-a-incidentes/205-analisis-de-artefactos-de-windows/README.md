...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-205%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **9 — Forense digital y respuesta a incidentes** · 📖 Fuente: *SANS FOR500 — Windows Forensic Analysis* y documentación de Microsoft
...
```mermaid
flowchart LR
    C["🔬 Clase 205<br/>Análisis de artefactos de<br/>Windows"]
    C --> T1["1 · Hives del registro"]
    C --> T2["2 · Prefetch"]
    C --> T3["3 · ShimCache / AmCache"]
    C --> T4["4 · Event Logs (EVTX)"]
    C --> T5["5 · Jump Lists y LNK"]
    C --> T6["6 · ShellBags"]
    C --> T7["7 · UserAssist / RecentDocs"]
    C --> T8["8 · Herramientas EZ y<br/>RegRipper"]

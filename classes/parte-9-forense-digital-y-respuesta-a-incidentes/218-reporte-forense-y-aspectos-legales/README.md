...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-218%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **9 — Forense digital y respuesta a incidentes** · 📖 Fuente: *SWGDE Best Practices* y NIST SP 800-86
...
```mermaid
flowchart LR
    C["🔬 Clase 218<br/>Reporte forense y aspectos<br/>legales"]
    C --> T1["1 · Estructura del informe"]
    C --> T2["2 · Hechos vs. opinión"]
    C --> T3["3 · Admisibilidad de evidencia"]
    C --> T4["4 · Cadena de custodia en el<br/>informe"]
    C --> T5["5 · Audiencias del informe"]
    C --> T6["6 · Testimonio pericial"]
    C --> T7["7 · Privacidad y notificación"]
    C --> T8["8 · Retención y<br/>confidencialidad"]

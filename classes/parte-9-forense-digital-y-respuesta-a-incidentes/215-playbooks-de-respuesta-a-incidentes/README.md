...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-215%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **9 — Forense digital y respuesta a incidentes** · 📖 Fuente: *Roberts & Brown — Intelligence-Driven Incident Response* y NIST SP 800-61
...
```mermaid
flowchart LR
    C["🔬 Clase 215<br/>Playbooks de respuesta a<br/>incidentes"]
    C --> T1["1 · Qué es un playbook"]
    C --> T2["2 · Anatomía: fases, roles,<br/>decisiones"]
    C --> T3["3 · Playbook de phishing"]
    C --> T4["4 · Playbook de ransomware"]
    C --> T5["5 · Playbook de cuenta<br/>comprometida"]
    C --> T6["6 · Integración con ATT&CK"]
    C --> T7["7 · SOAR y automatización"]
    C --> T8["8 · Mantenimiento del playbook"]

...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-287%20%2F%20340-6e7781?style=flat-square)](../../README.md)
...
```mermaid
flowchart LR
    C["📋 Clase 287<br/>Métricas de seguridad"]
    C --> T1["1 · Por qué medir"]
    C --> T2["2 · KPI vs. KRI vs. KCI"]
    C --> T3["3 · Métricas SMART y umbrales"]
    C --> T4["4 · Métricas operativas (MTTD,<br/>MTTR)"]
    C --> T5["5 · Vanity metrics"]
    C --> T6["6 · Cuadros de mando por<br/>audiencia"]
    C --> T7["7 · Cadencia y tendencia"]

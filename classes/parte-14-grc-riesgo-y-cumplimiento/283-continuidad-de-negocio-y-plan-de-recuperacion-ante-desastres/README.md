...
[![Clase](https://img.shields.io/badge/%F0%9F%93%97%20clase-283%20%2F%20340-6e7781?style=flat-square)](../../README.md)

</div>

> 🗂️ Parte: **14 — GRC, riesgo y cumplimiento** · 📖 Fuente: *(ISC)² CISSP Official Study Guide e ISO 22301*
...
```mermaid
flowchart LR
    C["📋 Clase 283<br/>Continuidad de negocio y<br/>plan de recuperación…"]
    C --> T1["1 · BCP vs. DRP vs. respuesta<br/>a incidentes"]
    C --> T2["2 · BIA (Business Impact<br/>Analysis)"]
    C --> T3["3 · Métricas: RTO, RPO, MTD,<br/>WRT"]
    C --> T4["4 · Estrategias de<br/>recuperación"]
    C --> T5["5 · Sitios alternativos<br/>(frío/tibio/caliente)"]
    C --> T6["6 · Estrategia de backups<br/>(3-2-1)"]
    C --> T7["7 · Pruebas y mantenimiento<br/>del plan"]

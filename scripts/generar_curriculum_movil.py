...
RESOURCE_SPECS = (
    ...
    {
        "path": ROOT / "rutas" / "divulgacion-responsable.md",
        "id": "rol-divulgacion-responsable",
        "icon": "📨",
        "title": "Responsible Disclosure / CVD",
        "subtitle": "Ruta del responsable de divulgación coordinada de vulnerabilidades",
        "description": "Ingreso, reproducción, triaje, coordinación multiparte, publicación, métricas, portafolio y progresión profesional.",
        "notice": "La coordinación no autoriza investigación fuera de alcance ni sustituye asesoría legal.",
        "searchTerms": "Responsible Disclosure CVD Vulnerability Disclosure Coordinator VDP PSIRT coordinador divulgación vulnerabilidades rol carrera",
    },
    {
        "path": ROOT / "rutas" / "investigador-seguridad.md",
        "id": "rol-investigador-seguridad",
        "icon": "🔬",
        "title": "Investigador/a de seguridad",
        "subtitle": "Ruta de Security Researcher",
        "description": "Método experimental, especialidades, laboratorio reproducible, evidencia, divulgación, portafolio y progresión profesional.",
        "notice": "Investiga exclusivamente activos propios, laboratorios o sistemas expresamente autorizados.",
        "searchTerms": "Security Researcher investigador investigación vulnerabilidades fuzzing reversing malware hardware web rol carrera",
    },
    {

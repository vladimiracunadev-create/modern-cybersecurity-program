...
- Frente a [GRC / Gestión de seguridad](grc.md): GRC **asesora y mide**; el jefe de seguridad
...
- Frente al [Analista de Ciberseguridad](analista-ciberseguridad.md): ese perfil **opera** el SIEM
...
- Frente al [Security Engineer / SecOps](secops-engineer.md): construye los controles; tú decides
...
> ([AFP PlanVital, *Jefe de Seguridad de la Información*, Santiago de Chile](https://www.linkedin.com/jobs/view/4443991364)):
...
[analista de ciberseguridad](analista-ciberseguridad.md) o infraestructura— y se le añade la capa
...
5. 📚 [**Parte 9 — DFIR**](../classes/parte-9-forense-digital-y-respuesta-a-incidentes/README.md)
   ...
   comité de crisis.
6. 📚 [**Partes 1, 3 y 4**](../classes/parte-1-redes-y-seguridad-de-redes/README.md) · la base
...
- 🏛️ [276 · Gobernanza de la seguridad de la información](../classes/parte-14-grc-riesgo-y-cumplimiento/276-gobernanza-de-la-seguridad-de-la-informacion/README.md) — el marco del cargo: quién decide qué.
- 📊 [277 · Gestión de riesgos cuantitativa y cualitativa](../classes/parte-14-grc-riesgo-y-cumplimiento/277-gestion-de-riesgos-cuantitativa-y-cualitativa/README.md) y [328 · Gestión de riesgos cuantitativa y continuidad avanzada](../classes/parte-17-profundizacion-para-certificaciones/328-gestion-de-riesgos-cuantitativa-y-continuidad-avanzada/README.md) — el idioma con el que se pide presupuesto.
- 📕 [278 · ISO/IEC 27001 e implantación de un SGSI](../classes/parte-14-grc-riesgo-y-cumplimiento/278-iso-iec-27001-e-implantacion-de-un-sgsi/README.md) y [279 · NIST Cybersecurity Framework](../classes/parte-14-grc-riesgo-y-cumplimiento/279-nist-cybersecurity-framework/README.md) — los dos marcos que la oferta nombra literalmente.
- 📈 [287 · Métricas de seguridad: KPIs y KRIs](../classes/parte-14-grc-riesgo-y-cumplimiento/287-metricas-de-seguridad-kpis-y-kris/README.md) y [321 · Comunicación y reporte para analistas de seguridad](../classes/parte-17-profundizacion-para-certificaciones/321-comunicacion-y-reporte-para-analistas-de-seguridad/README.md) — **el reporte ejecutivo mensual**, que es tu producto más visible.
- ⚖️ [320 · Gobierno, aspectos legales, regulatorios y gestión del programa](../classes/parte-17-profundizacion-para-certificaciones/320-gobierno-aspectos-legales-regulatorios-y-gestion-del-programa/README.md) — el terreno del regulador y la auditoría externa.
- 🩹 [318 · Gestión del programa de vulnerabilidades](../classes/parte-17-profundizacion-para-certificaciones/318-gestion-del-programa-de-vulnerabilidades/README.md) y [071 · Nessus y OpenVAS](../classes/parte-3-hacking-etico-y-pentesting-metodologia/071-analisis-de-vulnerabilidades-con-nessus-y-openvas/README.md) — supervisar el ciclo completo, con la herramienta que se pide.
- 🧱 [324 · Operaciones de seguridad, hardening y gestión de configuración](../classes/parte-17-profundizacion-para-certificaciones/324-operaciones-de-seguridad-hardening-y-gestion-de-configuracion/README.md) y [329 · Arquitectura de seguridad empresarial y zero trust](../classes/parte-17-profundizacion-para-certificaciones/329-arquitectura-de-seguridad-empresarial-y-zero-trust/README.md) — el hardening y la arquitectura que supervisas.
- 🔎 [183 · SIEM: arquitectura y componentes](../classes/parte-8-blue-team-deteccion-y-soc/183-siem-arquitectura-y-componentes/README.md) y [197 · Métricas y madurez del SOC](../classes/parte-8-blue-team-deteccion-y-soc/197-metricas-y-madurez-del-soc/README.md) — para exigirle al SIEM lo que puede dar, y medirlo.
- 🔁 [283 · Continuidad de negocio y recuperación ante desastres](../classes/parte-14-grc-riesgo-y-cumplimiento/283-continuidad-de-negocio-y-plan-de-recuperacion-ante-desastres/README.md) y [219 · Ejercicios de mesa (tabletop)](../classes/parte-9-forense-digital-y-respuesta-a-incidentes/219-ejercicios-de-mesa-tabletop/README.md) — obligatorio en sector regulado.
- 🤝 [284 · Gestión de riesgo de terceros y proveedores](../classes/parte-14-grc-riesgo-y-cumplimiento/284-gestion-de-riesgo-de-terceros-y-proveedores/README.md) y [288 · Seguros cibernéticos](../classes/parte-14-grc-riesgo-y-cumplimiento/288-seguros-ciberneticos/README.md) — transferir riesgo, no solo mitigarlo.
- 🧑‍🏫 [286 · Concienciación y cultura de seguridad](../classes/parte-14-grc-riesgo-y-cumplimiento/286-concienciacion-y-cultura-de-seguridad/README.md) — el programa que tendrás que sostener todos los años.

### Laboratorio y práctica

La práctica de este rol **no es un laboratorio de hacking**, y conviene decirlo claro:

- 🎲 [219 · Ejercicios de mesa (tabletop)](../classes/parte-9-forense-digital-y-respuesta-a-incidentes/219-ejercicios-de-mesa-tabletop/README.md) — **tu ejercicio principal**: dirige un simulacro de crisis con roles, decisiones y comunicación. Es lo más parecido al trabajo real.
...
- 🧪 [`blue-team-soc`](../labs/blue-team-soc/README.md) y [`rootcause-windows`](../labs/rootcause-windows/README.md) — para **no perder el contacto técnico**: el día que dejas de entender lo que hace tu equipo, empiezas a decidir a ciegas.
- 🧪 [`cloud-security`](../labs/cloud-security/README.md) — auditar postura de nube con herramientas de CSPM: el tipo de evidencia que revisarás en informes.
...
- 🏛️ [**CISSP**](../certificaciones/cissp.md) — **la certificación faro** del rol: gobernanza,
  ...
  de conocimiento.
- 📋 [**CompTIA CySA+** (CS0-003)](../certificaciones/comptia-cysa-plus-cs0-003.md) — útil para la
...
pero no el examen. Consulta el [mapeo completo](../certificaciones/README.md).
...
en comunicación ejecutiva; o **por la vía de gestión/auditoría** ([GRC](grc.md), auditoría interna,
...
1. **Ten una base técnica primero.** Si no vienes de un rol defensivo, haz antes
   [SOC / Blue Team](soc-blue-team.md), [gestión de vulnerabilidades](gestion-vulnerabilidades.md)
   o [analista de ciberseguridad](analista-ciberseguridad.md). Sin eso, este cargo te queda grande
   y el equipo lo nota en la primera semana.
2. **Haz la Parte 14 completa.** Es el núcleo del puesto y la única parte del programa que no
...
4. **Construye los entregables del cargo** sobre una organización ficticia: registro de riesgos,
...
5. **Practica la parte que no es técnica.** Presenta un riesgo en cinco minutos a alguien sin
   formación en seguridad y pídele que te repita qué decisión tiene que tomar. Si no puede, no fue
   culpa suya.
6. **Busca liderazgo antes del título.** Lidera un proyecto, mentoriza a alguien, coordina un
...
7. Planifica **CISSP** o **CISM** a medio plazo, y **ISO 27001 Lead Implementer** si tu organización

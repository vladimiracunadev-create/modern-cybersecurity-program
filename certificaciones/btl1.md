...
> **Código:** BTL1 · **Proveedor:** Security Blue Team · **Nivel:** Fundacional (defensivo, práctico) · [Página oficial](https://www.securityblue.team/certifications/blue-team-level-1)
...
`█████████░` 87.5% — suma ponderada por dominio (pesos estimados (el proveedor no publica ponderación oficial por dominio)).
...
| Threat Intelligence | 15% | Parte 8 | 82% | Inteligencia operacional, IOCs, ATT&CK. |
...
Ruta 'Analista SOC / Blue Team' + lab blue-team-soc. Ver [rutas por rol](../rutas/README.md) y la [Parte 16 — preparación de certificaciones](../classes/parte-16-capstones-y-preparacion-de-certificaciones/README.md).
